...
time.sleep(0.5)
client.send(socket, f'set-scripts monitor.1>monitor.2>metronome.on/record.1>record.2/play.1>play.2>record.3>metronome.on/play.3>monitor.4/monitor.4/monitor.1>mute.2>mute.3>monitor.4/play.1>play.2/record.1>mute.2>mute.3>monitor.4/play.1>play.2>play.3>monitor.4')
time.sleep(0.5)
